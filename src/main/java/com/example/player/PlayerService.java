...
public class PlayerService implements PlayerRepository {
    ...
    public ArrayList<Player> getPlayers() {
        ...
        ArrayList<Player> player = new ArrayList<>(playerCollection);
        return player;
    }
    ...
    public Player updatePlayer(int playerId, Player player) {
        ...
        Player exitingPlayer = team.get(playerId);
        ...
        if (player.getJerseyNumber() != 0) {
            exitingPlayer.setJerseyNumber(player.getJerseyNumber());

        }

        if (player.getRole() != null) {
            exitingPlayer.setRole(player.getRole());
        }
